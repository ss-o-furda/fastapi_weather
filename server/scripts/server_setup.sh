...
cp /apps/app_repo/fastapi_weather/server/units/weather.service /etc/systemd/system/
...
cp /apps/app_repo/fastapi_weather/server/nginx/weather.nginx /etc/nginx/sites-enabled/
